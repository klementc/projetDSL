...
public class DSLSATYalsatSolver {
	/**
	 * Solve from a file
	 * @param path the path to the cnf file
	 */
	public static boolean processCNFWithYalsat(String path)
	{
	...
	public static boolean processFromDSLSATWithYalsat(String path)
	{
		...
		return processCNFWithYalsat(path+".cnf");
	...
	public static void main(String[] args) 
	{
		...
		path = sc.next();
		processFromDSLSATWithYalsat(path);
	}
}
