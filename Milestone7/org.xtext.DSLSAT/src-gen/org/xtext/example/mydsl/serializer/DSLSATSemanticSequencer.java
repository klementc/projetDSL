...
public class DSLSATSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DSLSATPackage.eINSTANCE)
			...
			case DSLSATPackage.FORM:
				if (rule == grammarAccess.getBiImplFormRule()
						|| action == grammarAccess.getBiImplFormAccess().getBiImplFormLeftAction_1_0()
						|| rule == grammarAccess.getImplFormRule()
						|| action == grammarAccess.getImplFormAccess().getImplFormLeftAction_1_0()
						|| rule == grammarAccess.getOrFormRule()
						|| action == grammarAccess.getOrFormAccess().getOrFormLeftAction_1_0()
						|| rule == grammarAccess.getAndFormRule()
						|| action == grammarAccess.getAndFormAccess().getAndFormLeftAction_1_0()
						|| rule == grammarAccess.getNandFormRule()
						|| action == grammarAccess.getNandFormAccess().getNandFormLeftAction_1_0()
						|| rule == grammarAccess.getFormRule()
						|| action == grammarAccess.getNotFormAccess().getNotFormFormAction_2()) {
					sequence_Form(context, (Form) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getModelRule()) {
					sequence_Model(context, (Form) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *
	 * Constraint:
	 *     (solver='SAT4J' | solver='MINISAT' | solver='YALSAT')
	 */
	 ...
	 *
	 * Constraint:
	 *     (annot=Annotation? (form=BiImplForm | path=STRING))
	 */
	protected void sequence_Model(ISerializationContext context, Form semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
