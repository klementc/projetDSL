...
public class DSLSATSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DSLSATPackage.eINSTANCE)
			...
			case DSLSATPackage.CONST:
				...
				return; 
			case DSLSATPackage.EQ_FORM:
				sequence_ImplForm(context, (EqForm) semanticObject); 
				return; 
	 ...
	 *     ImplForm.EqForm_1_0 returns AndForm
	 ...
	 *     ImplForm.EqForm_1_0 returns Form
	 *     OrForm returns Form
	...
	/**
	 * Contexts:
	 *     Model returns EqForm
	 *     BiImplForm returns EqForm
	 *     BiImplForm.BiImplForm_1_0 returns EqForm
	 *     ImplForm returns EqForm
	 *     ImplForm.EqForm_1_0 returns EqForm
	 *
	 * Constraint:
	 *     (left=ImplForm_EqForm_1_0 right=OrForm)
	 */
	protected void sequence_ImplForm(ISerializationContext context, EqForm semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DSLSATPackage.Literals.EQ_FORM__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DSLSATPackage.Literals.EQ_FORM__LEFT));
			if (transientValues.isValueTransient(semanticObject, DSLSATPackage.Literals.EQ_FORM__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DSLSATPackage.Literals.EQ_FORM__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getImplFormAccess().getEqFormLeftAction_1_0(), semanticObject.getLeft());
	 ...
	 *     ImplForm.EqForm_1_0 returns NandForm
	...
	protected void sequence_NotForm(ISerializationContext context, NotForm semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DSLSATPackage.Literals.NOT_FORM__FORM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DSLSATPackage.Literals.NOT_FORM__FORM));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *     ImplForm.EqForm_1_0 returns OrForm
