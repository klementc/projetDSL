...
public class DSLSATAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DSLSATSwitch<Adapter> modelSwitch =
    new DSLSATSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseEqForm(EqForm object)
      {
        return createEqFormAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.mydsl.dSLSAT.EqForm <em>Eq Form</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createEqFormAdapter()
  {
    return null;
  }
