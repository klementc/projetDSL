...
public class DSLSATPackageImpl extends EPackageImpl implements DSLSATPackage
{
   ...
   * @generated
   */
  private EClass eqFormEClass = null;
   ...
   * @generated
   */
  public EReference getEqForm_Left()
  {
    return (EReference)eqFormEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getEqForm_Right()
  {
    return (EReference)eqFormEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getNotForm_Form()
  {
    return (EReference)notFormEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(formEClass, FORM__F);
    ...
    eqFormEClass = createEClass(EQ_FORM);
    createEReference(eqFormEClass, EQ_FORM__LEFT);
    createEReference(eqFormEClass, EQ_FORM__RIGHT);
    ...
    createEReference(notFormEClass, NOT_FORM__FORM);
  }
  ...
  public void initializePackageContents()
  {
    ...
    eqFormEClass.getESuperTypes().add(this.getForm());
    ...
    initEReference(getForm_F(), ecorePackage.getEObject(), null, "f", null, 0, 1, Form.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(eqFormEClass, EqForm.class, "EqForm", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getEqForm_Left(), this.getForm(), null, "left", null, 0, 1, EqForm.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getEqForm_Right(), this.getForm(), null, "right", null, 0, 1, EqForm.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getNotForm_Form(), this.getForm(), null, "form", null, 0, 1, NotForm.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
