...
public class DSLSATParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DSLSATGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFormAccess().getFAssignment_0(), "rule__Form__FAssignment_0");
			builder.put(grammarAccess.getFormAccess().getFAssignment_1(), "rule__Form__FAssignment_1");
			builder.put(grammarAccess.getFormAccess().getFAssignment_2(), "rule__Form__FAssignment_2");
			builder.put(grammarAccess.getFormAccess().getFAssignment_3_1(), "rule__Form__FAssignment_3_1");
