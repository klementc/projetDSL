...
public class DSLSATParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DSLSATGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModelAccess().getXheckAssignment_0(), "rule__Model__XheckAssignment_0");
			builder.put(grammarAccess.getModelAccess().getFormAssignment_1(), "rule__Model__FormAssignment_1");
