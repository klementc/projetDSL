...
public class DSLSATParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DSLSATGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAnnotationAccess().getSolverAlternatives_1_0(), "rule__Annotation__SolverAlternatives_1_0");
			...
			builder.put(grammarAccess.getModelAccess().getGroup_2_1(), "rule__Model__Group_2_1__0");
			...
			builder.put(grammarAccess.getModelAccess().getAnnotAssignment_0(), "rule__Model__AnnotAssignment_0");
			builder.put(grammarAccess.getModelAccess().getXheckAssignment_1(), "rule__Model__XheckAssignment_1");
			builder.put(grammarAccess.getModelAccess().getFormAssignment_2_0(), "rule__Model__FormAssignment_2_0");
			builder.put(grammarAccess.getModelAccess().getPathAssignment_2_1_1(), "rule__Model__PathAssignment_2_1_1");
			builder.put(grammarAccess.getAnnotationAccess().getSolverAssignment_1(), "rule__Annotation__SolverAssignment_1");
